...
/* ================================================================== */
/*  Reads the JSON error body from a failed /api/evaluate response so   */
/*  the real server-side message reaches the UI instead of just a       */
/*  bare status code.                                                   */
/* ================================================================== */
async function readErrorMessage(res) {
  try {
    const data = await res.json();
    return data.detail || data.error || `Evaluation engine returned ${res.status}`;
  } catch {
    return `Evaluation engine returned ${res.status}`;
  }
}
